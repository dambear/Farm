      ...
      */}
          ...
          <div className='overflow-auto rounded-lg shadow'>
                ...
                <thead className='bg-emerald-400 shadow-md'>
                    <tr>
                        <th className='p-3 text-white text-lg font-semi-bold tracking-wide items-center'>Nutrient</th>
                        <th className='p-3 text-white text-lg font-semi-bold tracking-wide items-center'>Optimal Range</th>
                        <th className='p-3 text-white text-lg font-semi-bold tracking-wide items-center'>Unit</th>
                        <th className='p-3 text-white text-lg font-semi-bold tracking-wide items-center'>Function</th>
