...
function RecipientList({ selectedItems, filteredData, handleRemoveItem }) {
  ...
  return (
    <div className="bg-gray-100 w-[500px] h-28 flex flex-wrap border-2 overflow-y-auto p-2">
      {selectedItems.map((item, index) => {
        ...
        return (
          <div
            key={index}
            className="flex h-11 border-2 border-gray-300 rounded-xl p-1 mx-1 mt-1"
