...
import failedImg from "../../static/notif-alert/failed.png";

const FailedCustomAlert = ({ message, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div
       ...
       border-red-500 shadow-2xl shadow-red-500/40 transform scale-0 transition-transform duration-300"
      >
        <div className="bg-white rounded-3xl shadow-lg p-6">
          <div className="flex flex-col justify-center items-center">
            <img className="w-48" src={failedImg} alt="" />

            <label className="text-[27px] font-bold my-3">Sorry •́︵•̀</label>
          </div>
...
export default FailedCustomAlert;
