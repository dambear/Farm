            ...
            {farmerData
              ...
              .map((farmer) => (
                ...
                >
                  ...
                  <td className="p-3 text-center justify-center text-xl font-medium text-black border-b">
                  ...
                  <td className="p-3 flex items-center text-gray-700 text-center justify-center border-b ">
                    <button
                      class="py-2 px-4 rounded-xl flex items-center mr-2.5 text-xl font-navheader border-2 border-yellow-300 bg-yellow-300
                    ...
                    <button
                      class="py-2 px-4 rounded-xl flex items-center text-xl font-navheader border-2 border-red-400 bg-red-400
