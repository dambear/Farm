    ...
    return (
        <div className="p-4 ">
            ...
            <thead className='bg-emerald-400 shadow-md'>
                <tr >
                    <th className="p-3 text-white text-lg font-semi-bold tracking-wide items-center flex justify-center"><BsFillPersonVcardFill size='18' className='mr-1.5'/>ID</th>
                    <th className="p-3 text-white text-lg font-semi-bold tracking-wide items-center justify-center">First Name</th>
                    <th className="p-3 text-white text-lg font-semi-bold tracking-wide items-center justify-center">Last Name</th>
                    <th className="p-3 text-white text-lg font-semi-bold tracking-wide items-center justify-center">Age</th>
                    <th className="p-3 text-white text-lg font-semi-bold tracking-wide items-center justify-center">Contact</th>
                    <th className="p-3 text-white text-lg font-semi-bold tracking-wide items-center flex justify-center">Actions 
                    ...
                    <p className='flex items-center'><BsFillTrashFill size='24' className='fill-red-500 mr-1.5'/>Delete Data</p>
                    </span>
                    </div>
            ...
            <tbody className='divide-y divide-gray-100'>
                {farmerData.map((farmer) => (
                    <tr className='hover:bg-gray-200 border-b border-gray-300' key={farmer.farmer_id}>
                        <td className="p-3 text-xl font-medium  font-bold text-blue-500 text-center border">{farmer.farmer_id}</td>
                        <td className="p-3 text-xl font-medium text-gray-700 text-center border text-black">{farmer.first_name}</td>
                        <td className="p-3 text-xl font-medium text-gray-700 text-center border text-black">{farmer.last_name}</td>
                        <td className="p-3 text-xl font-medium text-gray-700 text-center border text-black">{farmer.age}</td>
                        ...
                        <td className="p-5 text-gray-700 text-center justify-center border">
                            <button onClick={() => handleEdit(farmer)}><BsPencilSquare size='24' className='hover:fill-yellow-500  mr-4'/></button>
                            <button onClick={() => handleDelete(farmer.farmer_id)}><BsFillTrashFill size='24' className='hover:fill-red-500'/></button>                      
                        </td>
                    </tr>
                ))}
            </tbody>
